...
The domain is incidental. The design problems are general: no API, no persistent context, a mutable instruction set, and an output nobody should trust unverified.
